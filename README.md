...
### Pivot Tables
I inserted pivot tables to aid in analyzing the data to answer the objective questions. For instance a pivot table was created for ADT where month_recorded was thrown into rows and ADT DAX measure was thrown into values. Then two slicers for Junction and Year was inserted to filter the results.
